...
for DIR in $DIRS; do
  # Skip import-only schema dirs (e.g. schema/vrs, schema/gkm-core: real directories
  # holding only symlinks to an imported source + json, with no Makefile). There is
