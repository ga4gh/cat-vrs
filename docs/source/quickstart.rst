...
- `Cat-VRS <https://github.com/ga4gh/cat-vrs>`_ is used primarily for schema development.

- `Cat-VRS Python <https://github.com/ga4gh/cat-vrs-python>`_ is used for the development of the reference implementation, in Python.
