...
We recommend referring to specific :ref:`Recipes` of interest to your implementation when starting to represent concepts with Cat-VRS. Our :ref:`Quick Start <QuickStart>` guide also references software that may be helpful to both consume and produce Cat-VRS objects.
