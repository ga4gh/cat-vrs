...
| None | [BCR(ncbi:613)::ABL1(ncbi:25) and ABL1(ncbi:25) p.T315I](json/composite-ex1.json), [Hormone Receptor Positive](json/composite-ex2.json), [KIT p.D817V negative](json/composite-ex3.json), [KRAS (codons 12, 13, 59, 61, 117, 146) and NRAS (codons 12, 13, 59, 61, 117, 146) wild type](json/composite-ex4.json), [TP53 wild type](json/composite-ex5.json), [TP53 wild type and MDM2 amplification](json/composite-ex6.json), [t(2;15)(q23.1;q25.3)](json/describedVariant-ex1.json) |
