...
| FeatureContextConstraint | [BRCA2 loss of function variants](json/functionVariant-ex2.json), [Estrogen receptor](json/proteinMarker-ex1.json), [NRAS functionally normal variants](json/functionVariant-ex1.json), [PIK3CA p.R38H](json/functionVariant-ex3.json), [TP53 Loss](json/tp53-copy-loss.annotated.json), [TP53 Loss](json/tp53-copy-loss.json) |
